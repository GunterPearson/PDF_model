...
def clean_text():
    ...
    text2 = []
    pages = convert_from_path("TEST/PeterFonda_Scanned.pdf", 500)
    for page in pages:
        text2.append(str(((pytesseract.image_to_string(page)))))
    # with open("TEST/PeterFonda_Scanned.pdf", mode='rb') as f:
